...
namespace MyMailSender
{
	...
	[global::System.Data.Linq.Mapping.DatabaseAttribute(Name="dbMyMailSender")]
    ...
    partial void DeleteRecipient(Recipient instance);
		...
		public RecipientsDataContext() : 
				base(global::MyMailSender.Properties.Settings.Default.dbMyMailSenderConnectionString, mappingSource)
		{
			OnCreated();
		}
